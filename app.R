...
library(scales)
# Retriving the data
df_stable <- read.csv('https://raw.githubusercontent.com/mglu123/DSCI_532_group_208_DashR_Job/master/most_stable_job.csv', header=TRUE , sep=',')
df_2M_pop <- read.csv('https://raw.githubusercontent.com/mglu123/DSCI_532_group_208_DashR_Job/master/2000_pop_job.csv', header=TRUE , sep=',')
